    ...
    private void convertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_convertActionPerformed
        ...
        if (temperatureFrom.getSelectedItem().equals("Celcius")){
            if (temperatureTo.getSelectedItem().equals("Fahrenheit")){
                double celcius = Double.parseDouble(displayFrom.getText()) * 1.8 + 32;
                displayTo.setText(celcius + "");
            }
            else if (temperatureTo.getSelectedItem().equals("Kelvin")){
                double celcius = Double.parseDouble(displayFrom.getText()) + 273.15;
                displayTo.setText(celcius + "");
            }
            else if (temperatureTo.getSelectedItem().equals("Reamur")){
                double celcius = Double.parseDouble(displayFrom.getText()) * 0.8;
                displayTo.setText(celcius + "");
            }
        }
        ...
        //FAHRENHEIT
            ...
            if (temperatureTo.getSelectedItem().equals("Celcius")){
                double fahrenheit = (Double.parseDouble(displayFrom.getText()) - 32) / 1.8;
                displayTo.setText(fahrenheit + "");
            }
            else if (temperatureTo.getSelectedItem().equals("Kelvin")){
                double fahrenheit = (Double.parseDouble(displayFrom.getText()) + 459.67) / 1.8;
                displayTo.setText(fahrenheit + "");
            }
            else if (temperatureTo.getSelectedItem().equals("Reamur")){
                double fahrenheit = (Double.parseDouble(displayFrom.getText()) - 32) / 2.25;
                displayTo.setText(fahrenheit + "");
            }
        }
        ...
        //KELVIN
            ...
            if (temperatureTo.getSelectedItem().equals("Fahrenheit")){
                double kelvin = Double.parseDouble(displayFrom.getText()) * 1.8 - 459.67;
                displayTo.setText(kelvin + "");
            }
            else if (temperatureTo.getSelectedItem().equals("Celcius")){
                double kelvin = Double.parseDouble(displayFrom.getText()) - 273.15;
                displayTo.setText(kelvin + "");
            }
            else if (temperatureTo.getSelectedItem().equals("Reamur")){
                double kelvin = (Double.parseDouble(displayFrom.getText()) - 273.15) * 0.8;
                displayTo.setText(kelvin + "");
            }
        }
        ...
        //REAMUR
            ...
            if (temperatureTo.getSelectedItem().equals("Fahrenheit")){
                double reamur = (Double.parseDouble(displayFrom.getText()) - 7.5) * 24 / 7 + 32;
                displayTo.setText(reamur + "");
            }
            else if (temperatureTo.getSelectedItem().equals("Kelvin")){
                double reamur = Double.parseDouble(displayFrom.getText()) / 0.8 + 273.15;
                displayTo.setText(reamur + "");
            }
            else if (temperatureTo.getSelectedItem().equals("Celcius")){
                double reamur = Double.parseDouble(displayFrom.getText()) / 0.8;
                displayTo.setText(reamur + "");
            }
        }
